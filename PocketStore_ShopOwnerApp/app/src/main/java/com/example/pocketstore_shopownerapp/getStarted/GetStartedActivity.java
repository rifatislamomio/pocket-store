package com.example.pocketstore_shopownerapp.getStarted;
...
import com.example.pocketstore_shopownerapp.misc.DeciderActivity;
...
public class GetStartedActivity extends AppCompatActivity implements GetStartedView{
    ...
    private static final int PERMISSION_CODE = 976;
    ...
    public void OnAuthUserNotExistsUI() {
        ...
        // need to set next activity to open for this app
        VerificationPageActivity.setNextActivityClassName(
                "com.example.pocketstore_shopownerapp.misc.DeciderActivity");
